    ...
    <script>
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/code/loginCode?"+new Date().getTime());
            });
            //ajxs登录
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admin/adminLogin" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/code/loginCode">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="loginCode" id="form-code">
                            </div>
